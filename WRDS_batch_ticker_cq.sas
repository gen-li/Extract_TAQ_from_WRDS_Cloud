filename input '/home/yale/genli925/cq_tsymbol_date.txt'; /* Change to your input file path */
...
data outputM;
	set %taq_monthly_dataset_list(type = cq) open=defer;	/* get TAQ Monthly data for desired dates */
...
proc export data = outputM outfile= '/home/yale/genli925/ticker_cqm/ticker_cq_missing_tsymbol.dta'; run;
